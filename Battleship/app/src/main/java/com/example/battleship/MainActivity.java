...
/* PLayer class which holds ships and matrix of tiles, the tiles hold state values and ship data
The state values are:
0 -  empty tile
1 - tile has ship part
2 - ship part is hit
3 - ship is sunk on that tile
4 - player hit empty tile
 */
